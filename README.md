...
[![Required ST Build](https://img.shields.io/badge/ST-4201+-orange.svg?style=flat-square&logo=sublime-text)](https://www.sublimetext.com)
...
- User-defined rules.
- (Optional) Deep learning based syntax detection. ([Magika][google-magika])
